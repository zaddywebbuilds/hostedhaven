...
export const services: Service[] = [
  {
    ...
    pillars: [
      ...
      { icon: 'trending', title: 'Revenue Strategy', hook: 'Your rate moves with the market.', text: 'Dynamic smart pricing, calendar strategy and real-time adjustments for San Antonio demand.' },
    ...
    detail: {
      ...
      bullets: [
        ...
        'Dynamic smart pricing and calendar optimization',
    ...
    steps: [
      { title: 'Property Form', text: 'You share the home, its location and your goals.' },
      { title: 'Overview Video', text: 'A short video explains how co-hosting with Hosted Havens works.' },
      { title: 'Property Tour', text: 'A paid on-site tour with extensive prep and a detailed analysis report.' },
    ...
    faqs: [
      ...
      { q: 'How much does Airbnb management cost with Hosted Havens?', a: 'The typical ongoing fee is 18%–22% per booking, with a one-time listing setup fee of $150–$500. Final pricing depends on your property type, condition, service requirements and agreed scope. See the <a href="/pricing/">pricing page</a> for details.' },
      ...
      { q: 'Do I sign a long-term contract?', a: 'No. Hosted Havens offers flexible service with no long-term contract.' },
      { q: 'How much can my property earn?', a: 'Every home is different, so there is no honest single number. The paid property tour looks at your home, location, amenities and comparable rentals, and you receive a detailed analysis report. Results vary by property, seasonality and market conditions.' },
    ],
  ...
  },
  {
    ...
    pillars: [
      ...
      { icon: 'users', title: 'A Local Team', hook: 'People who can actually get to the house.', text: 'Guest services, maintenance coordination, photography and revenue management support.' },
    ...
    detail: {
      ...
      bullets: [
        ...
        'Flexible service with no long-term contract',
      ],
    },
    faqs: [
      ...
      { q: 'How do I get started?', a: 'Complete the <a href="/property-analysis/">property form</a>. You then watch a short overview video, and when you are ready you book the paid property tour, which includes extensive preparation and a detailed analysis report.' },
    ],
  ...
  },
  {
    ...
    pillars: [
      { icon: 'chart', title: 'Dynamic Smart Pricing', hook: 'Rates that follow real demand.', text: 'Nightly prices adjust with market trends, day of week and how far out guests book.' },
      ...
      { icon: 'eye', title: 'Clear Insights', hook: 'See what your pricing is doing.', text: 'Transparent pricing performance data instead of a black box.' },
    ],
    detail: {
  ...
  },
  {
    ...
    intro: {
      ...
      paragraphs: [
        ...
        'Your listing is the first version of your home guests experience. Photography, title, description and amenity choices decide whether they click, book and leave a review that matches what they expected.',
      ],
    },
    pillars: [
  ...
  },
  {
    ...
    pillars: [
      ...
      { icon: 'sparkle', title: 'Arrival Setup & Restocking', hook: 'Nothing runs out mid-stay.', text: 'Low-inventory alerts, restocking and guest arrival preparation.' },
    ],
    detail: {
    ...
    faqs: [
      ...
      { q: 'Who handles maintenance?', a: 'Our maintenance coordination covers routine inspections, proactive maintenance and follow-up on issues, keeping owners informed.' },
    ],
